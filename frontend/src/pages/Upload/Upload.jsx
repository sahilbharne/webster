  ...
  const handleGenerateTags = async () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        // Auto-fill tags field with generated tags
        setFormData(prev => ({
          ...prev,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const artworkData = {
        ...
        artistName: 'Current User', // You can replace this with actual user data
        category: formData.category,
        price: 0,
        customTags: formData.tags
      };

      const result = await uploadArtworkWithTags(artworkData);
      ...
      setMessage('❌ Error uploading artwork. Please try again.');
    } finally {
